...
const Homepage = () => {
  return (
    <>  
        ...
        <NewsectionBtn title = "Our Gallery" desc = "Explore our extensive gallery of past tournaments and experience the excitement, competition, and memorable moments captured in each event." colour="darkblue" />
        <Newsection title = "News Stories" desc = "The Reis Table Tennis Tournament has garnered significant attention in the news, making headlines for its thrilling matches and outstanding competitors. Explore the various news stories below to see how this prestigious event has captivated audiences and media alike." colour="regular"/>
