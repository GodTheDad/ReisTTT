...
const Homepage = () => {
  return (
    <>  
        ...
        <NewsectionBtn title = "Our Gallery" desc = "Explore our extensive gallery of past tournaments and experience the excitement, competition, and memorable moments captured in each event." colour="regular" />
        <Newsection title = "News Stories" desc = "The Reis Table Tennis Torunament has been " colour="regular"/>
